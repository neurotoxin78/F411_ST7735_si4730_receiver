...
Core/lvgl/src/draw/nxp_pxp/%.o Core/lvgl/src/draw/nxp_pxp/%.su: ../Core/lvgl/src/draw/nxp_pxp/%.c Core/lvgl/src/draw/nxp_pxp/subdir.mk
...
clean-Core-2f-lvgl-2f-src-2f-draw-2f-nxp_pxp:
	-$(RM) ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp.d ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp.o ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp.su ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp_osa.d ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp_osa.o ./Core/lvgl/src/draw/nxp_pxp/lv_gpu_nxp_pxp_osa.su
