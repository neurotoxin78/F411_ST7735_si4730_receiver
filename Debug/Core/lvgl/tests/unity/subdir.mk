...
Core/lvgl/tests/unity/%.o Core/lvgl/tests/unity/%.su: ../Core/lvgl/tests/unity/%.c Core/lvgl/tests/unity/subdir.mk
...
clean-Core-2f-lvgl-2f-tests-2f-unity:
	-$(RM) ./Core/lvgl/tests/unity/unity.d ./Core/lvgl/tests/unity/unity.o ./Core/lvgl/tests/unity/unity.su ./Core/lvgl/tests/unity/unity_support.d ./Core/lvgl/tests/unity/unity_support.o ./Core/lvgl/tests/unity/unity_support.su
