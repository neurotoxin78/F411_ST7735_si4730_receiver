...
Core/lvgl/examples/others/snapshot/%.o Core/lvgl/examples/others/snapshot/%.su: ../Core/lvgl/examples/others/snapshot/%.c Core/lvgl/examples/others/snapshot/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-others-2f-snapshot:
	-$(RM) ./Core/lvgl/examples/others/snapshot/lv_example_snapshot_1.d ./Core/lvgl/examples/others/snapshot/lv_example_snapshot_1.o ./Core/lvgl/examples/others/snapshot/lv_example_snapshot_1.su
