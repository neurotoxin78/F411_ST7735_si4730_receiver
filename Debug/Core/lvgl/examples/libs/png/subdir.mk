...
Core/lvgl/examples/libs/png/%.o Core/lvgl/examples/libs/png/%.su: ../Core/lvgl/examples/libs/png/%.c Core/lvgl/examples/libs/png/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-libs-2f-png:
	-$(RM) ./Core/lvgl/examples/libs/png/img_wink_png.d ./Core/lvgl/examples/libs/png/img_wink_png.o ./Core/lvgl/examples/libs/png/img_wink_png.su ./Core/lvgl/examples/libs/png/lv_example_png_1.d ./Core/lvgl/examples/libs/png/lv_example_png_1.o ./Core/lvgl/examples/libs/png/lv_example_png_1.su
